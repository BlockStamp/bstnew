...
{
    const CWallet wallet("dummy", WalletDatabase::CreateDummy(), WalletDatabase::CreateDummy());
...
static const CWallet testWallet("dummy", WalletDatabase::CreateDummy(), WalletDatabase::CreateDummy());

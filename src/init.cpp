...
void SetupServerArgs()
{
    ...
    gArgs.AddArg("-msgminingthreads=<n>", strprintf("Set number of threads for sending message by minning (default: %u)", DEFAULT_MINING_THREADS), false, OptionsCategory::OPTIONS);
    gArgs.AddArg("-msgsavehistory", strprintf("Enable/disable storing sent communicator messeges (default: %d)", DEFAULT_MSG_SAVE_HISTORY), DEFAULT_MSG_SAVE_HISTORY, OptionsCategory::OPTIONS);

...
void SetupServerArgs()
{
    ...
    gArgs.AddArg("-msgminingthreads=<n>", strprintf("Set number of threads for sending message by minning (default: %u)", DEFAULT_MINING_THREADS), DEFAULT_MINING_THREADS, OptionsCategory::OPTIONS);
